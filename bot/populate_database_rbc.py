...
from bot.sand_rbc_farm.main import AREA_BARRON, adi_level, extract_raw_packet, parse_xt_packet, sands_level_from_gaa_value
...
def main(argv: list[str] | None = None) -> int:
    ...
    set_account_aid(resolve_aid(args.account_name))
